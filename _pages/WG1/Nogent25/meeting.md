...
- Nicolas Margulies continued his ongoing work on translating cubical type theory to lambdapi ([CubicalDk](https://github.com/nicomarg/CubicalDk)), proving some required lemmas about the deep embedding of cubical type theory and manipulation of DeBruijn indices. Furthermore, he worked with Michael Färber on a denotational semantics of the jq language.
